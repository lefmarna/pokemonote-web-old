<template>
  <div>
    <!-- wp:quote -->
    <p>
      本プライバシーポリシーは、<a href="https://pokemonit.com">ポケモニット</a
    ...
    <h3><strong>コメントを残した際に個人情報を取得します</strong></h3>
    <p>
    ...
    <p>
      ...
      <a
        ...
        >Gravatar </a
      >サービスを使用中かどうか確認するため同サービスに提供されることがあります。同サービスのプライバシーポリシーを確認する場合は、<a
    ...
    <h4><strong>利用目的について</strong></h4>
    <p>
      荒し対策やスパム検出に役立てるためと、訪問者の利便性のためです。また、当サイト内で「訪問者からこのようなコメントがありました」と紹介させていただく場合もあります。
    </p>
    <p>
      コメントが当サイトの管理人であるレフマーナ（以下、「管理人」とします。）に承認されると、プロフィール画像がコメントとともに一般公開されます。
    </p>
    <h4><strong>保存期間について</strong></h4>
    <p>
      当サイトに残されたコメントは、コメントとそのメタデータを3年間保存します<b
        >。</b
      >
    </p>
    <p>
    ...
    <h4><strong>当サイトがコメントに対してできることについて</strong></h4>
    <p>
    ...
    <h4><strong>個人情報取得の同意について</strong></h4>
    <p>
    ...
    <h3><strong>Cookieによる個人情報の取得</strong></h3>
    ...
    <h4><strong>保存期間について</strong></h4>
    <p>当サイトに残されたコメントの Cookie は、1年間保存されます<b>。</b></p>
    <h4><strong>第三者によるCookie情報の取得について</strong></h4>
    <p>
    ...
    <p>
      Googleアナリティクスの利用規約に関して確認したい場合は、<a
        href="https://www.google.com/analytics/terms/jp.html"
        target="_blank"
        rel="noopener noreferrer"
        >ここをクリック</a
      >してください。また、「ユーザーが
      Googleパートナーのサイトやアプリを使用する際のGoogleによるデータ使用」に関して確認したい場合は、<a
    ...
    <h2>
      <strong>第三者配信の広告サービスについて<br /></strong>
    </h2>
    <p>
    ...
    <p>
      訪問者は、広告設定で訪問者に合わせた広告（以下、「パーソナライズド広告」とします。）を無効にすることが出来ます。その設定をする場合は、<a
    ...
    <p>
      Googleによって広告の第三者配信が認められている広告配信事業者の詳細は、<a
